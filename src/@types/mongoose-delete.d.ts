// Copied from https://github.com/DefinitelyTyped/DefinitelyTyped/blob/d43bbb1/types/mongoose-delete/index.d.ts
...
declare module 'mongoose-delete' {
    ...
    declare namespace mongoose_delete {
        ...
        interface SoftDeleteModel<T extends mongoose.Document, QueryHelpers = {}> extends mongoose.Model<T, QueryHelpers> {
             ...
             */
            delete(conditions?: any, deleteBy?: any, fn?: Callback<T, this>): mongoose.Query<any, T>;

            /**
             * Restore documents by conditions
             */
            restore(conditions?: any, fn?: Callback<T, this>): mongoose.Query<any, T> & QueryHelpers;
            ...
            deleteById(
                ...
                fn?: Callback<T, this>,
            ): mongoose.Query<any, T> & QueryHelpers;
        }
